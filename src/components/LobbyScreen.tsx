    ...
    <div className="min-h-screen flex flex-col items-center px-5 py-10" style={{ background: 'var(--bg-void)' }}>
      ...
      <div className="text-center mb-8 fade-in">
        <div className="mb-2 flex justify-center">
          <img src={lanternLogo} alt="Lantern" className="h-12" style={{ mixBlendMode: 'screen', filter: 'drop-shadow(0 0 12px #C9A84C)' }} />
        </div>
        ...
        {isDM ? (
          <>
            <button onClick={handleStartCombat} disabled={!canStart || loading}
              ...
              {loading ? 'Preparing battle…' : canStart ? '⚔️  Prepare Encounter' : 'Waiting for Players…'}
            </button>
            {!canStart && (
